...
class Parser:
  ...
  def atom(self):
    ...
    elif tok.type == TT_BOOLEAN:
        res.register_advancement()
        self.advance()
        return res.success(BooleanNode(tok))  # You need to define BooleanNode similar to NumberNode

    return res.failure(InvalidSyntaxError(
        tok.pos_start, tok.pos_end,
        "Expected int, float, identifier, '+', '-', '(', '[', 'IF', 'FOR', 'WHILE', 'FUN', or boolean"
    ))
